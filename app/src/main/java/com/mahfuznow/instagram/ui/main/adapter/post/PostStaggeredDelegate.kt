...
class PostStaggeredDelegate @Inject constructor() : AdapterDelegate<ArrayList<Any>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder =
        SearchPostViewHolder(
            ItemPostStaggeredBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
